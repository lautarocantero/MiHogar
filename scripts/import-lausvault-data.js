...
const MOVEMENTS_DATA = [
  ...
  },
  {
    ...
    accountKey: 'tarjeta',
    categoryKey: 'otros',
    note: 'Saldo anterior de tarjeta (neto de pago del 11/08)'
  },
  {
    date: '2026-08-01',
    type: 'EXPENSE',
  ...
  },
  {
    ...
    accountKey: 'tarjeta',
    categoryKey: 'servicios',
    note: 'SERVICIO CUENTA CLASSIC (fijo)',
    paymentKey: 'classic'
  },
  {
    date: '2026-08-08',
  ...
  },
  {
    ...
    accountKey: 'tarjeta',
    categoryKey: 'otros',
    note: 'RSI*ZUREN ZHOU (sin categorizar)'
  },
  {
    date: '2026-08-11',
    type: 'EXPENSE',
  ...
  },
  {
    ...
    accountKey: 'tarjeta',
    categoryKey: 'supermercado',
    note: 'PVS*SUPERMERCADO PROSPERO'
  },
  {
    date: '2026-08-14',
    type: 'EXPENSE',
    ...
    accountKey: 'tarjeta',
    categoryKey: 'servicios',
    note: 'ANTHROPIC*CLAUD (fijo, US$20 x $1470)',
    paymentKey: 'claud'
  },
  {
    date: '2026-08-15',
  ...
  },
  {
    ...
    accountKey: 'tarjeta',
    categoryKey: 'otros',
    note: 'Impuestos e intereses del resumen (sellos, IVA, RG5617, financiación)'
  },
  {
    date: '2026-08-27',
    type: 'EXPENSE',
    ...
    accountKey: 'tarjeta',
    categoryKey: 'supermercado',
    note: 'Mercado (27/08, ciclo siguiente)'
  },
  {
    date: '2026-08-28',
    type: 'EXPENSE',
    ...
    accountKey: 'tarjeta',
    categoryKey: 'salud',
    note: 'corte de pelo/rodriguez estilista'
  },
  {
    date: '2026-08-29',
    type: 'EXPENSE',
  ...
  },
  {
    ...
    amount: 218030,
    accountKey: 'banco',
    note: 'Ingreso por horas (18.54h x US$8 x $1470)'
  },
  ...
  },
  {
    ...
    amount: 200445.53,
    accountKey: 'banco',
    toAccountKey: 'tarjeta',
    note: 'Pago resumen tarjeta mes anterior (ARS)'
  },
  {
    date: '2026-09-04',
    type: 'TRANSFER',
    ...
    accountKey: 'banco',
    toAccountKey: 'tarjeta',
    note: 'Pago resumen tarjeta mes anterior (USD 20 x $1470)'
  },
  {
    date: '2026-09-06',
    type: 'EXPENSE',
...
function findOrCreatePayment(vault, data, accountId, categoryId, owner, created) {
  const existing = vault.payments.find(
    (p) => p.concept.trim().toLowerCase() === data.concept.trim().toLowerCase()
  )
  if (existing) return existing.id
  const payment = {
    id: randomUUID(),
...
async function main() {
  ...
  console.log('\nResumen:')
  console.log(
    `  Cuentas nuevas: ${createdAccounts.length ? createdAccounts.join(', ') : '(ninguna, ya existían)'}`
  )
  console.log(
    `  Categorías nuevas: ${createdCategories.length ? createdCategories.join(', ') : '(ninguna, ya existían)'}`
  )
  console.log(
    `  Gastos fijos nuevos: ${createdPayments.length ? createdPayments.join(', ') : '(ninguno, ya existían)'}`
  )
  console.log(
    `  Movimientos: ${addedMovements} nuevos, ${skippedMovements} ya existentes (omitidos)`
  )
